...
func _update_portrait(passed_character:DialogicCharacter, passed_portrait:String) -> void:
	...
	# Appliquer immédiatement la couleur selon l'état sans animation
...
func _should_do_portrait_update(_character: DialogicCharacter, _portrait: String) -> bool:
	return true  # Permet la mise à jour instantanée

func _set_portrait(_passed_portrait: String) -> void:
	# Override pour forcer une mise à jour sans transition
	pass
